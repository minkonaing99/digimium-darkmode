            ...
            <div id="inputRow" class="input-form">
                <form>
                    <div class="form-row">
                        ...
                        <div class="form-col">
                            <label for="wc_price" class="form-label text-danger">WC Price</label>
                            <input type="number" id="wc_price" step="1" placeholder="Enter price">
                        </div>
                        <div class="form-col">
                            <label for="retail_price" class="form-label text-danger">Retail Price</label>
                            <input type="number" id="retail_price" step="1" placeholder="Enter price">
                        </div>
                        <div class="form-col form-submit">
                            <label class="invisible">Save</label>
                ...
                <form id="editForm">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col">
                            ...
                            <input type="text" id="edit_notes" placeholder="Notes" autocomplete="off">
                        </div>
                        <div class="form-col">
                        ...
                        <div class="form-col">
                            <label for="edit_wc_price" class="form-label text-danger">WC Price</label>
                            <input type="number" id="edit_wc_price" step="1" placeholder="Enter price">
                        </div>
                        <div class="form-col">
                            <label for="edit_retail_price" class="form-label text-danger">Retail Price</label>
                            <input type="number" id="edit_retail_price" step="1" placeholder="Enter price">
                        </div>
                        <div class="form-col form-submit">
                            <label class="invisible">Save</label>
