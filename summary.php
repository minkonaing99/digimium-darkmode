        ...
        <section class="era-table-card mb " aria-labelledby="tbl-title">
            ...
            <div class="kpi-grid">
                <article class="kpi-card">
                    ...
                    <div class="kpi-value" data-target="0" data-suffix=" Ks">0 Ks
                    </div>
                </article>

                <article class="kpi-card">
                    <div class="kpi-label">Daily Profits</div>
                    <div class="kpi-value" data-target="0" data-suffix=" Ks">0 Ks</div>
                </article>

                <article class="kpi-card">
                    <div class="kpi-label">Monthly Sales</div>
                    <div class="kpi-value" data-target="1007500" data-suffix=" Ks">0 Ks</div>
                </article>

                <article class="kpi-card">
                    <div class="kpi-label">Monthly Profits</div>
                    <div class="kpi-value" data-target="407500" data-suffix=" Ks">0 Ks</div>
                </article>
            </div>
        </section>
